                ...
                <form id="filter">
                    <div class="row">
                        <div class="col-2">
                            ...
                            <input class="form-control datepicker" type="text" id="startDate" name="startDate">
                        </div>
                        <div class="col-2">
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="${meal.description}" id="description" name="description" required>
                    </div>
                    <div class="form-group">
                        <label for="calories" class="col-form-label"><spring:message code="meal.calories"/>:</label>
                        <input class="form-control" type="number" value="${meal.calories}" id="calories" name="calories" required>
                    </div>
                </form>
            </div>
